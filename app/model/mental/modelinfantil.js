...
modelinfantil.prototype.buscarleito = function(callback){
	
	this._conection.query('select * from mentalleito where id_leito = 1;', callback);
}

modelinfantil.prototype.updateleito = function(leitofemad,leitomascad, callback){

	this._conection.query('update mentalleito set leitofemad = "'+leitofemad+'", leitomascad = "'+leitomascad+'"  where id_leito = 1 ', callback);
}

modelinfantil.prototype.cadastrarpaciente = function(dataatu, horas,prt,paciente, idade,diagnostico,referencia,unidade,data,tratamento,risco,internacao, juizo, comportamento,exposicao,autonegligencia,dependencia,terapeutico,social,soma, callback){
...
modelinfantil.prototype.update = function(idpaciente,dataatu, horas, prt,paciente, idade,diagnostico,referencia,unidade,tratamento,risco,internacao, juizo,comportamento,exposicao,autonegligencia,dependencia,terapeutico,social,soma, callback){
