...
modelsaojorge.prototype.buscarleitosid = function(valor,callback){
	...
	this._conection.query('select idleitos from leitos where idsetor = (select idsetor from setor where setor = "'+valor[0].setor+'"and unidade = "Sao Jorge") and leito = "'+valor[0].leito+'" and unidade = "Sao Jorge" and status = "Inativo"', callback);
...
modelsaojorge.prototype.updateleitos = function(idsetor, leito, callback){
...
modelsaojorge.prototype.updatefugulindados = function(idpaciente, mental2,oxigenacao2,sinaisvitais2,motilidade2,deambulacao2,alimentacao2,cuidado2,eliminacao2,terapeutica2,integridade2,curativo2,tempo2,fugulin,unidade, callback){
...
modelsaojorge.prototype.updatetissdados = function(idpaciente, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,unidade, callback){
...
modelsaojorge.prototype.updatenewsdados = function(idpaciente, setor, news, fr, sat, temp, o2, sistolica, fc, alerta, unidade, callback){

	this._conection.query('update news set setor="'+setor+'", fr= "'+fr+'",sat= "'+sat+'",o2= "'+o2+'",temp= "'+temp+'",fc= "'+fc+'",sistolica= "'+sistolica+'",alerta= "'+alerta+'",news= "'+news+'",unidade= "'+unidade+'" where idpaciente = ' + idpaciente, callback);
}
