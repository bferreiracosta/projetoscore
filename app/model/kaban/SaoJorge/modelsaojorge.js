...
modelsaojorge.prototype.buscarpacienterelatorio = function(unidade, callback){
...
modelsaojorge.prototype.buscarpacienterelatoriocovid = function(unidade, callback){
...
modelsaojorge.prototype.buscarpacienterelatoriomental = function(unidade, callback){
...
modelsaojorge.prototype.buscarpacientesemleitos = function(unidade, callback){
	
	this._conection.query('SELECT * FROM kaban where kaban.unidade = "SaoJorge" and kaban.baixa is null and idpaciente not in (select idpaciente from leitokaban where idpaciente is not null);', callback);
}


modelsaojorge.prototype.buscarexames = function(callback){
	
	this._conection.query('select * from evento where title IS NOT NULL and unidade = "SaoJorge"', callback);
}

modelsaojorge.prototype.buscarexamesid = function(idevento, callback){
	
	this._conection.query('select * from evento where idevento = ' + idevento.id, callback);
}

modelsaojorge.prototype.addexame = function(title, start,end, paciente, unidade, callback){
	
	this._conection.query('insert into evento set title = "'+title+'", start = "'+start+'",end = "'+end+'", paciente = "'+paciente+'", unidade = "'+unidade+'"', callback);
}

modelsaojorge.prototype.updateexamesaojorge = function(idevento, title, start, paciente, end, callback){
...
modelsaojorge.prototype.deleteexamesaojorge = function(idevento, callback){
	
	this._conection.query('delete from  evento  where idevento = ' + idevento, callback);
}

modelsaojorge.prototype.buscarleitospacientes = function(callback){
	
	this._conection.query('SELECT * FROM portal_paciente.leitokaban inner join kaban on leitokaban.idpaciente = kaban.idpaciente where kaban.unidade = "SaoJorge" and kaban.baixa is null;', callback);
}

modelsaojorge.prototype.cadastrarleitossaojorge = function(callback){
	
	this._conection.query('select * from leitokaban where unidade = "SaoJorge"', callback);
}

modelsaojorge.prototype.addcentralid = function(idpaciente,nome, unidade,callback){
	
	this._conection.query('insert leitokaban set idpaciente = "'+idpaciente+'", nome="'+nome+'", unidade="'+unidade+'"', callback);
}

modelsaojorge.prototype.baixacentral = function(idpaciente,baixa, callback){

	this._conection.query('update leitokaban set baixa = "'+baixa+'" where idpaciente = ' + idpaciente, callback);
}

modelsaojorge.prototype.buscarleitosid = function(valor,callback){

	this._conection.query('select idleito from leitos where idsetor = (select idsetor from setor where setor = "'+valor[0].setor+'"and unidade = "SaoJorge") and leitos = "'+valor[0].leito+'" and unidade = "SaoJorge" and status = "Inativo" limit 1', callback);
}

modelsaojorge.prototype.buscarleitosnome = function(valor,callback){

	this._conection.query('select idleito from leitokaban where nome = "'+valor[0].nome+'"', callback);
}

modelsaojorge.prototype.buscarleitospacientesporid = function(valor, callback){

	this._conection.query('select idleito from leitokaban where idpaciente = "'+valor+'"', callback);
}

modelsaojorge.prototype.buscarleitospacientespornome = function(valor, callback){
	
	this._conection.query('select nome from leitokaban where idpaciente = "'+valor+'"', callback);
}

modelsaojorge.prototype.atualizarleitokaban = function(idleito, idpaciente, nome, callback){
	
	this._conection.query('update leitokaban set idpaciente = "'+idpaciente+'", nome = "'+nome+'"  where idleito = "'+idleito+'"', callback);
}

modelsaojorge.prototype.mudarpacienteleito = function(idleito, callback){
	
	this._conection.query('update leitokaban set idpaciente = null, nome = null  where idleito = "'+idleito+'"', callback);
}

modelsaojorge.prototype.buscarleitoativo = function(idsetor, leito, callback){
...
modelsaojorge.prototype.updateleitos = function(idleito, callback){

	this._conection.query('update leitos set status = "Inativo"  where idleito = "'+idleito[0].idleito+'"', callback);
}

modelsaojorge.prototype.updateleitosnome = function(idpaciente, paciente,unidade, callback){

	this._conection.query('update leitokaban set nome = "'+paciente+'"  where idpaciente = "'+idpaciente+'" and unidade = "'+unidade+'"', callback);
}

modelsaojorge.prototype.updateleitosativo = function(idleito, callback){

	this._conection.query('update leitos set status = "Ativo" where idleito = "'+idleito+'"', callback);
}

modelsaojorge.prototype.buscarsetoresid = function(setor, callback){
	
	this._conection.query('select idsetor from setor where setor = "'+setor+'"  and unidade = "SaoJorge"', callback);
}

modelsaojorge.prototype.buscarpacientessaojorge = function(callback){
	
	this._conection.query('select * from kaban where unidade = "SaoJorge" and baixa is null', callback);
}

modelsaojorge.prototype.buscarpacientesidsaojorge = function(valor, callback){
	
	this._conection.query('select idpaciente from kaban where unidade = "SaoJorge" and baixa is null and nome="'+valor.valor+'"', callback);
}

modelsaojorge.prototype.buscardispositivohora = function(unidade, callback){
...
modelsaojorge.prototype.buscarfugulinhora = function(unidade, callback){
...
modelsaojorge.prototype.buscarnewshora = function(unidade, callback){
...
modelsaojorge.prototype.buscartisshora = function(unidade, callback){
...
modelsaojorge.prototype.buscarfugulinid = function(idpaciente, unidade, callback){

	this._conection.query('select * from fugulin where unidade = "'+unidade+'" and idpaciente = "'+idpaciente.id+'" and status = "Ativo"', callback);
}

modelsaojorge.prototype.buscardispositivoid = function(idpaciente, unidade, callback){
...
modelsaojorge.prototype.buscarnews = function(unidade, callback){
...
modelsaojorge.prototype.buscartiss = function(unidade, callback){
...
modelsaojorge.prototype.buscardispositivo = function(unidade, callback){
...
modelsaojorge.prototype.buscardispositivodataid = function(idpaciente, unidade, callback){
...
modelsaojorge.prototype.buscarfugulindataid = function(idpaciente, unidade, callback){
...
modelsaojorge.prototype.buscarnewsdataid = function(idpaciente, unidade, callback){
...
modelsaojorge.prototype.buscartissdataid = function(idpaciente, unidade, callback){
...
modelsaojorge.prototype.buscarpacienteporid = function(idpaciente, callback){
	
	this._conection.query('select * from kaban where idpaciente = ' + idpaciente, callback);
}

modelsaojorge.prototype.buscarsetor = function(idpaciente, callback){
...
modelsaojorge.prototype.updatedispositivostatus = function(iddispositivo, callback){
	
	this._conection.query('update dispositivokaban set status = "Inativo" where iddispositivo = '+ iddispositivo, callback);
}

modelsaojorge.prototype.adddispositivo = function(idpaciente,nome, glasgow, bic,svd,datasvd,sne,datasne,avp,dataavp,cvc,datacvc,gtt,datagtt,sng,datasng,dispositivoventilatorio,fluxoo2,fio2,peep,drogas,nora,vazaonora,adre,vazaoadre,bica,vazaobica,sedacao,dormonid3,vazaoDormonid,fentanil3,vazaoFentanil,rocuronio3,vazaoRocuronio,propofol3,vazaoPropofol,data,unidade, callback){
...
modelsaojorge.prototype.adddispositivoid = function(idpaciente,nome, unidade,callback){
	
	this._conection.query('insert dispositivokaban set idpaciente = "'+idpaciente+'", nome="'+nome+'", unidade="'+unidade+'",status= "Ativo"', callback);
}

modelsaojorge.prototype.updatedispositivonome = function(idpaciente, nome, callback){

	this._conection.query('update dispositivokaban set nome= "'+nome+'" where idpaciente = ' + idpaciente, callback);
}

modelsaojorge.prototype.addfugulinid = function(idpaciente,setor, nome, unidade, callback){
...
modelsaojorge.prototype.addfugulin = function(idpaciente, setor, nome, mental2,oxigenacao2,sinaisvitais2,motilidade2,deambulacao2,alimentacao2,cuidado2,eliminacao2,terapeutica2,integridade2,curativo2,tempo2,fugulin,data,unidade, callback){
...
modelsaojorge.prototype.updatefugulin = function(idpaciente, mental2,oxigenacao2,sinaisvitais2,motilidade2,deambulacao2,alimentacao2,cuidado2,eliminacao2,terapeutica2,integridade2,curativo2,tempo2,fugulin,data,unidade, callback){
...
modelsaojorge.prototype.updatefugulinnome = function(idpaciente, nome, setor, callback){

	this._conection.query('update fugulin set nome= "'+nome+'",setor= "'+setor+'"  where idpaciente = ' + idpaciente, callback);
}

modelsaojorge.prototype.updatefugulindados = function(idpaciente,data, mental2,oxigenacao2,sinaisvitais2,motilidade2,deambulacao2,alimentacao2,cuidado2,eliminacao2,terapeutica2,integridade2,curativo2,tempo2,fugulin,unidade, callback){
...
modelsaojorge.prototype.updatefugulinstatus = function(idfugulin, callback){

	this._conection.query('update fugulin set status = "Inativo" where idfugulin = '+ idfugulin, callback);
}

modelsaojorge.prototype.addtissid = function(idpaciente,setor, nome,unidade,callback){
	
	this._conection.query('insert tiss set idpaciente = "'+idpaciente+'",setor="'+setor+'", nome="'+nome+'", unidade="'+unidade+'",status= "Ativo"', callback);
}

modelsaojorge.prototype.addtiss = function(idpaciente, setor , nome, tiss ,data,unidade, callback){
...
modelsaojorge.prototype.updatetiss = function(idpaciente, tiss ,data,unidade, callback){
...
modelsaojorge.prototype.updatetissdados = function(idpaciente,data, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,unidade, callback){
...
modelsaojorge.prototype.updatetissstatus = function(idtiss, callback){

	this._conection.query('update tiss set status = "Inativo" where idtiss = '+ idtiss, callback);
}

modelsaojorge.prototype.updatetissnome = function(idpaciente, nome,setor, callback){

	this._conection.query('update tiss set nome= "'+nome+'", setor= "'+setor+'" where idpaciente = ' + idpaciente, callback);
}

modelsaojorge.prototype.addnewsid = function(idpaciente,setor, nome, unidade,callback){
	
	this._conection.query('insert news set idpaciente = "'+idpaciente+'", setor="'+setor+'", nome="'+nome+'", unidade="'+unidade+'", status= "Ativo"', callback);
}

modelsaojorge.prototype.addnews = function(idpaciente, setor, nome,news, data, fr, sat, temp, o2, sistolica, fc, alerta, unidade, callback){
...
modelsaojorge.prototype.updatenews = function(idpaciente, setor, news, data, fr, sat, temp, o2, sistolica, fc, alerta, unidade, callback){
...
modelsaojorge.prototype.updatenewsdados = function(idpaciente,data, setor, news, fr, sat, temp, o2, sistolica, fc, alerta, unidade, callback){
...
modelsaojorge.prototype.updatenewsstatus = function(idnews, callback){

	this._conection.query('update news set status = "Inativo" where idnews = '+ idnews, callback);
}

modelsaojorge.prototype.updatenewsnome = function(idpaciente, nome,setor, callback){
	
	this._conection.query('update news set nome= "'+nome+'", setor= "'+setor+'" where idpaciente = ' + idpaciente, callback);
}

modelsaojorge.prototype.buscarclinicosaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscartraumatologiasaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscarpediatriasaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscarpsquiatriasaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscarcirurgicosaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscarevasaosaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscartransferenciasaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscarobitosaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscarinternacaodiasaojorge = function(unidade, callback){
...
modelsaojorge.prototype.buscarsetoressaojorge = function(callback){

	this._conection.query('select lui.idsaojorge, lui.setor, lui.capacidade, lui.capacidadecamas, (select count(acomodacao) from leitokaban where unidade = "SaoJorge" and acomodacao="Cama" and nome is not null and setor = lui.setor) as qtdcama,lui.capacidademacas,(select count(acomodacao) from leitokaban where unidade = "SaoJorge" and acomodacao="Maca" and nome is not null and setor = lui.setor) as qtdmaca,lui.bloqueado, lui.datas, lui.hora from saojorge lui', callback);
}

modelsaojorge.prototype.buscarbanhomanhasaojorge = function(callback){

	this._conection.query('SELECT count(banho) as manha from kaban where banho = "Manhã" and baixa is null and unidade = "SaoJorge";', callback);
}

modelsaojorge.prototype.buscarbanhotardesaojorge = function(callback){

	this._conection.query('SELECT count(banho) as tarde from kaban where banho = "Tarde"  and baixa is null and unidade = "SaoJorge";', callback);
}

modelsaojorge.prototype.buscarbanhonoitesaojorge = function(callback){

	this._conection.query('SELECT count(banho) as noite from kaban where banho = "Noite"  and baixa is null and unidade = "SaoJorge";', callback);
}

modelsaojorge.prototype.buscardieta1 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta2 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta3 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta4 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta5 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta6 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta7 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta8 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta9 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta10 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta11 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta12 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta13 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta14 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta15 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta16 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta17 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta18 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta19 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta20 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta21 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta22 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta23 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta24 = function(unidade,callback){
...
modelsaojorge.prototype.buscardieta25 = function(unidade,callback){
