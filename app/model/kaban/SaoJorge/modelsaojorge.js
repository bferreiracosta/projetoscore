...
modelsaojorge.prototype.cadastrarpaciente = function( paciente, dieta, exame, dataexame, mental, referencia, covid, glasgow, bic, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
...
modelsaojorge.prototype.update = function(idpaciente, dieta, dataexame, exame, mental, referencia, covid, glasgow, bic, setor, paciente,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
...
modelsaojorge.prototype.buscarsetoressaojorge = function(callback){
	...
	this._conection.query('SELECT setor, capacidadecamasocupadas, capacidademacasocupadas FROM saojorge', callback);
}
