...
modelsaojorge.prototype.buscarexames = function(callback){
	...
	this._conection.query('select * from evento where title IS NOT NULL and unidade = "Sao Jorge"', callback);
}
...
modelsaojorge.prototype.buscarleitospacientes = function(callback){
	...
	this._conection.query('select * from leitokaban where baixa is null and unidade = "Sao Jorge"', callback);
}
...
modelsaojorge.prototype.buscarleitosid = function(valor,callback){
	...
	this._conection.query('select idleito from leitos where idsetor = (select idsetor from setor where setor = "'+valor[0].setor+'"and unidade = "Sao Jorge") and leito = "'+valor[0].leito+'" and unidade = "Sao Jorge" and status = "Inativo" limit 1', callback);
...
modelsaojorge.prototype.atualizarleitokaban = function(idpaciente, setor, leito, callback){
...
modelsaojorge.prototype.buscarsetoresid = function(setor, callback){
	...
	this._conection.query('select idsetor from setor where setor = "'+setor+'"  and unidade = "Sao Jorge"', callback);
}

modelsaojorge.prototype.buscarsetores = function(callback){
	
	this._conection.query('select * from setor inner join leitos on setor.idsetor = leitos.idsetor where status != "Inativo" and setor.unidade = "Sao Jorge"  group by setor', callback);
}

modelsaojorge.prototype.buscarleitos = function(valor, callback){

	this._conection.query('select * from leitos inner join setor on setor.idsetor = leitos.idsetor where setor = "'+valor.valor+'" and status = "Ativo" and setor.unidade = "Sao Jorge"', callback);
...
modelsaojorge.prototype.cadastrarpaciente = function( paciente, medico, dieta, exame, dataexame, mental, referencia, covid, glasgow, bic, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
...
modelsaojorge.prototype.update = function(idpaciente, medico, dieta, dataexame, exame, mental, referencia, covid, glasgow, bic, setor, paciente,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
...
modelsaojorge.prototype.adddispositivo = function(idpaciente,nome,svd,datasvd,sne,datasne,avp,dataavp,cvc,datacvc,dispositivoventilatorio,fluxoo2,fio2,peep,drogas,nora,vazaonora,adre,vazaoadre,bica,vazaobica,sedacao,dormonid3,vazaoDormonid,fentanil3,vazaoFentanil,rocuronio3,vazaoRocuronio,propofol3,vazaoPropofol,data,unidade, callback){
...
modelsaojorge.prototype.addtiss = function(idpaciente, setor , nome, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,data,unidade, callback){
...
modelsaojorge.prototype.updatetiss = function(idpaciente, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,data,unidade, callback){
...
modelsaojorge.prototype.buscarsetoressaojorge = function(callback){
	...
	this._conection.query('SELECT setor, capacidadecamasocupadas, capacidademacasocupadas, capacidade FROM saojorge', callback);
}
