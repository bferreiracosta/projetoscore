...
modelmartins.prototype.atualizarleitokaban = function(idpaciente, setor, leito,acomodacao, callback){
...
modelmartins.prototype.buscaracomodacao = function(valor, callback){

	this._conection.query('select * from acomodacao inner join setor on acomodacao.idsetor = setor.idsetor inner join leitos on acomodacao.idleito = leitos.idleito where setor.setor = "'+valor.valorsetor+'" and leitos = "'+valor.valorleito+'" and acomodacao.unidade = "Martins" and leitos.status = "Ativo";', callback);
