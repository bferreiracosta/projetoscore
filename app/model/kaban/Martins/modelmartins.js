...
modelmartins.prototype.buscarpacienterelatoriocovid = function(unidade, callback){
...
modelmartins.prototype.buscarpacienterelatoriomental = function(unidade, callback){
...
modelmartins.prototype.buscarpacientesemleitos = function(unidade, callback){
	
	this._conection.query('SELECT * FROM kaban where kaban.unidade = "Martins" and kaban.baixa is null and idpaciente not in (select idpaciente from leitokaban where idpaciente is not null);', callback);
}
...
modelmartins.prototype.buscarleitospacientes = function(callback){
	...
	this._conection.query('SELECT * FROM portal_paciente.leitokaban inner join kaban on leitokaban.idpaciente = kaban.idpaciente where kaban.unidade = "Martins" and kaban.baixa is null;', callback);
}

modelmartins.prototype.cadastrarleitosmartins = function(callback){
	
	this._conection.query('select * from leitokaban where unidade = "Martins"', callback);
}
...
modelmartins.prototype.buscarleitosid = function(valor,callback){
	...
	this._conection.query('select idleito from leitos where idsetor = (select idsetor from setor where setor = "'+valor[0].setor+'"and unidade = "Martins") and leitos = "'+valor[0].leito+'" and unidade = "Martins" and status = "Inativo" limit 1', callback);
}
...
modelmartins.prototype.atualizarleitokaban = function(idleito, idpaciente, nome, callback){
	
	this._conection.query('update leitokaban set idpaciente = "'+idpaciente+'", nome = "'+nome+'"  where idleito = "'+idleito+'"', callback);
}

modelmartins.prototype.mudarpacienteleito = function(idleito, callback){
...
modelmartins.prototype.updateleitosnome = function(idpaciente, paciente,unidade, callback){
...
modelmartins.prototype.buscarpacientesmartins = function(callback){
	
	this._conection.query('select * from kaban where unidade = "Martins" and baixa is null', callback);
}

modelmartins.prototype.buscarpacientesidmartins = function(valor, callback){
	
	this._conection.query('select idpaciente from kaban where unidade = "Martins" and baixa is null and nome="'+valor.valor+'"', callback);
}
...
modelmartins.prototype.cadastrarpaciente = function( paliatividades, Suspeição,paciente, round, alta,metas, agenexames, laudo, descexame, desclaudo, oxigenios, casas, avespecialistas,descespecialista, coletas, resultadolabs, transferencias, desctransferencia, hemos, medico, dieta, exame, dataexame, mental, referencia, covid, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
	
	this._conection.query('insert into kaban set paliatividades = "'+paliatividades+'", suspeicao = "'+Suspeição+'", round = "'+round+'", planoalta = "'+alta+'", metas = "'+metas+'", agenexames = "'+agenexames+'", laudo = "'+laudo+'", descexame = "'+descexame+'", desclaudo = "'+desclaudo+'", oxigenios = "'+oxigenios+'", casas = "'+casas+'", avespecialistas = "'+avespecialistas+'", descespecialista = "'+descespecialista+'", coleta = "'+coletas+'", resultadolabs = "'+resultadolabs+'", transferencias = "'+transferencias+'", desctransferencia = "'+desctransferencia+'", hemos = "'+hemos+'", medico = "'+medico+'", dieta = "'+dieta+'", exame = "'+exame+'", dataexame = "'+dataexame+'",mental = "'+mental+'", referencia = "'+referencia+'", covid = "'+covid+'", nome = "'+paciente+'", comodo = "'+setor+'", susfacil = "'+susfacil+'",prt = "'+prt+'", datanascimento = "'+dn+'", idade = "'+idade+'", dataentrada = "'+da+'", qtddiasinternados = "'+qtdi+'" , ECF = "'+ecf+'", spict="'+spict+'" , paliativo = "'+paliativo+'" , diagnostico = "'+diagnostico+'" ,especialidade = "'+especialidade+'" ,observacao = "'+observacao+'" , banho = "'+banho+'" , pendencias = "'+pendencias+'" ,mobilidade = "'+mobilidade+'", unidade = "'+unidade+'"',callback);
}

modelmartins.prototype.update = function(paliatividades, Suspeição,idpaciente, paciente, round, alta,metas, agenexames, laudo, descexame, desclaudo, oxigenios,casas, avespecialistas,descespecialista, coletas, resultadolabs, transferencias, desctransferencia, hemos, medico, dieta, exame, dataexame, mental, referencia, covid, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
	
	this._conection.query('update kaban set paliatividades = "'+paliatividades+'", suspeicao = "'+Suspeição+'",round = "'+round+'", planoalta = "'+alta+'", metas = "'+metas+'", agenexames = "'+agenexames+'", laudo = "'+laudo+'", descexame = "'+descexame+'", desclaudo = "'+desclaudo+'", oxigenios = "'+oxigenios+'", casas = "'+casas+'", avespecialistas = "'+avespecialistas+'", descespecialista = "'+descespecialista+'", coleta = "'+coletas+'", resultadolabs = "'+resultadolabs+'", transferencias = "'+transferencias+'", desctransferencia = "'+desctransferencia+'", hemos = "'+hemos+'", medico = "'+medico+'", dieta = "'+dieta+'", dataexame="'+dataexame+'", exame="'+exame+'", mental = "'+mental+'", referencia = "'+referencia+'", covid = "'+covid+'",  nome = "'+paciente+'", comodo = "'+setor+'", susfacil = "'+susfacil+'",prt = "'+prt+'", datanascimento = "'+dn+'", idade = "'+idade+'", dataentrada = "'+da+'", qtddiasinternados = "'+qtdi+'" , ECF = "'+ecf+'", spict="'+spict+'" ,  paliativo = "'+paliativo+'" , diagnostico = "'+diagnostico+'" ,especialidade = "'+especialidade+'" ,observacao = "'+observacao+'" , banho = "'+banho+'" , pendencias = "'+pendencias+'" ,mobilidade = "'+mobilidade+'", unidade = "'+unidade+'" where idpaciente = ' + idpaciente, callback);
}
...
modelmartins.prototype.adddispositivo = function(idpaciente,nome, glasgow, bic,svd,datasvd,sne,datasne,avp,dataavp,cvc,datacvc,gtt,datagtt,sng,datasng,dispositivoventilatorio,fluxoo2,fio2,peep,drogas,nora,vazaonora,adre,vazaoadre,bica,vazaobica,sedacao,dormonid3,vazaoDormonid,fentanil3,vazaoFentanil,rocuronio3,vazaoRocuronio,propofol3,vazaoPropofol,data,unidade, callback){
...
modelmartins.prototype.addtiss = function(idpaciente, setor , nome, tiss ,data,unidade, callback){
...
modelmartins.prototype.updatetiss = function(idpaciente, tiss ,data,unidade, callback){
...
modelmartins.prototype.buscardieta26 = function(unidade,callback){
...
modelmartins.prototype.buscardieta27 = function(unidade,callback){
...
modelmartins.prototype.buscardieta28 = function(unidade,callback){
...
modelmartins.prototype.buscardieta29 = function(unidade,callback){
...
modelmartins.prototype.buscardieta30 = function(unidade,callback){
...
modelmartins.prototype.buscardieta31 = function(unidade,callback){
