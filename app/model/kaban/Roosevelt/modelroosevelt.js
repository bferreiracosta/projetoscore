...
modelroosevelt.prototype.buscarsetoresroosevelt = function(callback){
	...
	this._conection.query('select roo.idroosevelt, roo.setor, roo.capacidade,roo.capacidadecamas, (select count(acomodacao) from leitokaban where unidade = "Planalto" and acomodacao="Cama" and nome is not null and setor = roo.setor) as qtdcama,roo.capacidademacas,(select count(acomodacao) from leitokaban where unidade = "Planalto" and acomodacao="Maca" and nome is not null and setor = roo.setor) as qtdmaca,roo.capacidadecadeiras,(select count(acomodacao) from leitokaban where unidade = "Planalto" and acomodacao="Cadeira" and nome is not null and setor = roo.setor) as qtdcadeira, roo.capacidadebercos,(select count(acomodacao) from leitokaban where unidade = "Planalto" and acomodacao="Berço" and nome is not null and setor = roo.setor) as qtdbercos, roo.bloqueado, roo.datas, roo.hora from roosevelt roo', callback);
}
