...
modelpampulha.prototype.buscarleitosid = function(valor,callback){
	...
	this._conection.query('select idleitos from leitos where idsetor = (select idsetor from setor where setor = "'+valor[0].setor+'"and unidade = "Pampulha") and leito = "'+valor[0].leito+'" and unidade = "Pampulha" and status = "Inativo"', callback);
...
modelpampulha.prototype.updateleitos = function(idsetor, leito, callback){
...
modelpampulha.prototype.cadastrarpaciente = function( paciente, dieta, exame, dataexame, mental, referencia, covid, glasgow, bic, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
...
modelpampulha.prototype.update = function(idpaciente, dieta, dataexame, exame, mental, referencia, covid, glasgow, bic, setor, paciente,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
...
modelpampulha.prototype.updatefugulindados = function(idpaciente, mental2,oxigenacao2,sinaisvitais2,motilidade2,deambulacao2,alimentacao2,cuidado2,eliminacao2,terapeutica2,integridade2,curativo2,tempo2,fugulin,unidade, callback){
...
modelpampulha.prototype.addtiss = function(idpaciente, setor , nome, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,data,unidade, callback){
...
modelpampulha.prototype.updatetiss = function(idpaciente, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,data,unidade, callback){
...
modelpampulha.prototype.updatetissdados = function(idpaciente, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,unidade, callback){
...
modelpampulha.prototype.updatenewsdados = function(idpaciente, setor, news, fr, sat, temp, o2, sistolica, fc, alerta, unidade, callback){
