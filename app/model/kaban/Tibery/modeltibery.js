...
modeltibery.prototype.buscarpacienterelatoriocovid = function(unidade, callback){
...
modeltibery.prototype.buscarpacienterelatoriomental = function(unidade, callback){
...
modeltibery.prototype.update = function(paliatividades, Suspeição,idpaciente, paciente, round, alta,metas, agenexames, laudo, descexame, desclaudo, oxigenios,casas, avespecialistas,descespecialista, coletas, resultadolabs, transferencias, desctransferencia, hemos, medico, dieta, exame, dataexame, mental, referencia, covid, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, callback){
...
modeltibery.prototype.adddispositivo = function(idpaciente,nome, glasgow, bic,svd,datasvd,sne,datasne,avp,dataavp,cvc,datacvc,gtt,datagtt,sng,datasng,dispositivoventilatorio,fluxoo2,fio2,peep,drogas,nora,vazaonora,adre,vazaoadre,bica,vazaobica,sedacao,dormonid3,vazaoDormonid,fentanil3,vazaoFentanil,rocuronio3,vazaoRocuronio,propofol3,vazaoPropofol,data,unidade, callback){
...
modeltibery.prototype.buscarsetorestibery = function(callback){
	...
	this._conection.query('select tib.idtibery, tib.setor, tib.capacidade,tib.capacidadecamas, (select count(acomodacao) from leitokaban where unidade = "Tibery" and acomodacao="Cama" and nome is not null and setor = tib.setor) as qtdcama,tib.capacidademacas,(select count(acomodacao) from leitokaban where unidade = "Tibery" and acomodacao="Maca" and nome is not null and setor = tib.setor) as qtdmaca,tib.capacidadecadeiras,(select count(acomodacao) from leitokaban where unidade = "Tibery" and acomodacao="Cadeira" and nome is not null and setor = tib.setor) as qtdcadeira, tib.capacidadebercos,(select count(acomodacao) from leitokaban where unidade = "Tibery" and acomodacao="Berço" and nome is not null and setor = tib.setor) as qtdbercos, tib.bloqueado, tib.datas, tib.hora from tibery tib', callback);
}
...
modeltibery.prototype.buscardieta26 = function(unidade,callback){
...
modeltibery.prototype.buscardieta27 = function(unidade,callback){
...
modeltibery.prototype.buscardieta28 = function(unidade,callback){
...
modeltibery.prototype.buscardieta29 = function(unidade,callback){
...
modeltibery.prototype.buscardieta30 = function(unidade,callback){
...
modeltibery.prototype.buscardieta31 = function(unidade,callback){
