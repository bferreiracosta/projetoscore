...
modelpampulha.prototype.buscarpacientepornome = function(paciente, callback){
	
	this._conection.query('select id_paciente from pacientes where paciente = "'+paciente+'" and unidade = "Pampulha" order by id_paciente desc limit 1 ', callback);
	
}
modelpampulha.prototype.updaterespkaban = function(idpaciente,glasgow, bic,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivo,fluxoo2, droga, fio2, peep, sedacao, nora, adre,bica,dormonid,fentanil,rocuronio,propofol, callback){
