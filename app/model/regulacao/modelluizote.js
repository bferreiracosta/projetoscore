...
modelluizote.prototype.cadastrarpaciente = function(paciente, susfacil, prt, idade, leito,exame, unidade,paliativo,ecf,svd, sne, avp,cvc, spict,data, callback){
...
modelluizote.prototype.update = function(idpaciente, susfacil,prt, paciente, leito, idade, exame,paliativo,ecf,svd, sne, avp,cvc,spict, callback){
