...
modelmartins.prototype.cadastrarpaciente = function(paciente, susfacil, prt, idade, leito,exame, unidade,paliativo,ecf,svd, sne, avp,cvc, spict,data, callback){
...
modelmartins.prototype.update = function(idpaciente, susfacil,prt, paciente, leito, idade, exame,paliativo,ecf,svd, sne, avp,cvc,spict, callback){
...
modelmartins.prototype.updateresp = function(idpaciente,profissional,dispositivo,fluxoo2, droga, fio2, peep, sedacao, glasgow,leito, nora, adre,bica,dormonid,fentanil,rocuronio,propofol, bic, callback){
...
modelmartins.prototype.updateleitosmartins = function(idleitos,enffem,enfmasc,leitosdispo,macasdispo,se, callback){
