...
modelescalacapsi.prototype.updateferiasSN1 = function(idfuncionario, inputsituacao, dateinicialsituacao, datefinalsituacao, callback){

	this._conection.query('update folgacapsi set situacao = "'+inputsituacao+'", dateiniciosituacao = "'+dateinicialsituacao+'", datefinalsituacao = "'+datefinalsituacao+'" where idfolgacapsi = "'+idfuncionario+'"', callback);
}

modelescalacapsi.prototype.updateferiasSN2 = function(idfuncionario, inputsituacao, dateinicialsituacao, datefinalsituacao, callback){
...
modelescalacapsi.prototype.buscarsituacaocapsi = function(valor, callback){
	...
	this._conection.query('select situacao,dateiniciosituacao from folgacapsi where idfolgacapsi = "'+valor.idfinal+'"', callback )
}
