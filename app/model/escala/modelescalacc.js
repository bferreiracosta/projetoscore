...
modelescalacc.prototype.buscarsituacaocc = function(valor, callback){
	...
	this._conection.query('select situacao,dateiniciosituacao from folgacc where idfolgacc = "'+valor.idfinal+'"', callback )
}
