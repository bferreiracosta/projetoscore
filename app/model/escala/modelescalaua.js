...
modelescalaua.prototype.buscarsituacaoua = function(valor, callback){
	...
	this._conection.query('select situacao,dateiniciosituacao from folgaua where idfolgaua = "'+valor.idfinal+'"', callback )
}
