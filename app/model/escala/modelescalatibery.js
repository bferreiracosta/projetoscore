...
modelescalatibery.prototype.criarfolga =  function(funcionarios, escala, turno, callback){
	...
	if(turno == "Manhã"){
		var values = [
			...
			[funcionarios[26].idfuncionariostibery, escala],
		];
	}
	if(turno == "Tarde"){
		var values = [
