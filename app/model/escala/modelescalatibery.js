...
modelescalatibery.prototype.criarfolga =  function(funcionarios, escala, turno, callback){
	var sql = "insert into folgatibery (idfuncionarios,idescala) VALUES ?";
	if(turno == "Manhã"){
		var values = [
			[funcionarios[0].idfuncionariostibery, escala],
			[funcionarios[1].idfuncionariostibery, escala],
			[funcionarios[2].idfuncionariostibery, escala],
			[funcionarios[3].idfuncionariostibery, escala],
			[funcionarios[4].idfuncionariostibery, escala],
			[funcionarios[5].idfuncionariostibery, escala],
			[funcionarios[6].idfuncionariostibery, escala],
			[funcionarios[7].idfuncionariostibery, escala],
			[funcionarios[8].idfuncionariostibery, escala],
			[funcionarios[9].idfuncionariostibery, escala],
			[funcionarios[10].idfuncionariostibery, escala],
			[funcionarios[11].idfuncionariostibery, escala],
			[funcionarios[12].idfuncionariostibery, escala],
			[funcionarios[13].idfuncionariostibery, escala],
			[funcionarios[14].idfuncionariostibery, escala],
			[funcionarios[15].idfuncionariostibery, escala],
			[funcionarios[16].idfuncionariostibery, escala],
			[funcionarios[17].idfuncionariostibery, escala],
			[funcionarios[18].idfuncionariostibery, escala],
			[funcionarios[19].idfuncionariostibery, escala],
			[funcionarios[20].idfuncionariostibery, escala],
			...
			[funcionarios[25].idfuncionariostibery, escala],
		];
	}
	if(turno == "Tarde"){
		var values = [
...
modelescalatibery.prototype.updateferias = function(valor, callback){

	this._conection.query('update folgatibery set folga1="'+valor.folga1+'",folga2="'+valor.folga2+'",folga3="'+valor.folga3+'",folga4="'+valor.folga4+'",folga5="'+valor.folga5+'",folga6="'+valor.folga6+'",folga7="'+valor.folga7+'",folga8="'+valor.folga8+'",folga9="'+valor.folga9+'",folga10="'+valor.folga10+'",folga11="'+valor.folga11+'",folga12="'+valor.folga12+'",folga13="'+valor.folga13+'",folga14="'+valor.folga14+'",folga15="'+valor.folga15+'",folga16="'+valor.folga16+'",folga17="'+valor.folga17+'",folga18="'+valor.folga18+'",folga19="'+valor.folga19+'",folga20="'+valor.folga20+'",folga21="'+valor.folga21+'",folga22="'+valor.folga22+'",folga23="'+valor.folga23+'",folga24="'+valor.folga24+'",folga25="'+valor.folga25+'",folga26="'+valor.folga26+'",folga27="'+valor.folga27+'",folga28="'+valor.folga28+'",folga29="'+valor.folga29+'",folga30="'+valor.folga30+'",folga31="'+valor.folga31+'", situacaoferias = "'+valor.inputsituacaoferias+'", dateiniciosituacaoferias = "'+valor.dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+valor.datefinalsituacaoferias+'" where idfolgatibery = "'+valor.idfuncionario+'"', callback);
}
modelescalatibery.prototype.updateferiastarde = function(idfuncionario, inputsituacaoferias, dateinicialsituacaoferias, datefinalsituacaoferias, callback){

	this._conection.query('update folgatibery set situacaoferias = "'+inputsituacaoferias+'", dateiniciosituacaoferias = "'+dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+datefinalsituacaoferias+'" where idfolgatibery = "'+idfuncionario+'"', callback);
}

modelescalatibery.prototype.updateferiasSN1 = function(idfuncionario, inputsituacaoferias, dateinicialsituacaoferias, datefinalsituacaoferias, callback){

	this._conection.query('update folgatibery set situacaoferias = "'+inputsituacaoferias+'", dateiniciosituacaoferias = "'+dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+datefinalsituacaoferias+'" where idfolgatibery = "'+idfuncionario+'"', callback);
}

modelescalatibery.prototype.updateferiasSN2 = function(idfuncionario, inputsituacaoferias, dateinicialsituacaoferias, datefinalsituacaoferias, callback){

	this._conection.query('update folgatibery set situacaoferias = "'+inputsituacaoferias+'", dateiniciosituacaoferias = "'+dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+datefinalsituacaoferias+'" where idfolgatibery = "'+idfuncionario+'"', callback);
}

modelescalatibery.prototype.criarescalatibery = function(unidade, turno, dateinicial, datefinal, ano, callback){
	
	this._conection.query('insert into escalatibery set unidade="Tibery", turno="'+turno+'", dateinicial="'+dateinicial+'", datefinal="'+datefinal+'", dateano= "'+ano+'",rt="false",supervisao="false",cida="false"', callback);
}

modelescalatibery.prototype.validarescala = function(unidade, turno, dateinicial, datefinal, rt, supervisao, cida, callback){
	
	this._conection.query('update escalatibery set rt="'+rt+'",supervisao="'+supervisao+'",cida="'+cida+'" where  unidade="Tibery" and turno="'+turno+'" and dateinicial="'+dateinicial+'" and datefinal="'+datefinal+'"', callback);
}

modelescalatibery.prototype.buscarsituacaotibery = function(valor, callback){

	this._conection.query('select situacaoferias,dateiniciosituacaoferias from folgatibery where idfolgatibery = "'+valor.idfinal+'"', callback )
}
...
modelescalatibery.prototype.buscarescalamensaltibery = function(valor, callback){
	...
	this._conection.query('select * from folgatibery f inner join funcionariostibery func on f.idfuncionarios=func.idfuncionariostibery inner join escalatibery esc on f.idescala = esc.idescala where esc.dateinicial = "'+valor.datainicial+'" and  esc.datefinal = "'+valor.datafinal+'" and  esc.dateano = "'+valor.ano+'" and esc.turno = "'+valor.turno+'" and esc.unidade = "Tibery" order by func.categoria = "AUX", func.categoria = "Tec", func.categoria = "Enf Jr", func.categoria = "Enf",-func.nome DESC;', callback);
}
...
modelescalatibery.prototype.buscarescalamensaltiberymaq = function(valor, callback){
	...
	this._conection.query('select * from folgatibery f inner join funcionariostibery func on f.idfuncionarios=func.idfuncionariostibery inner join escalatibery esc on f.idescala = esc.idescala where esc.dateinicial = "'+valor.datainicial+'" and  esc.datefinal = "'+valor.datafinal+'" and  esc.dateano = "'+valor.ano+'" and esc.turno = "'+valor.turno+'" and esc.unidade = "Tibery" order by func.nome', callback);
}
