...
modelescalaroosevelt.prototype.criarfolga =  function(funcionarios, escala, turno, callback){
	...
	if(turno == "Manha"){
		var values = [
			...
			[funcionarios[2].idfuncionariosroosevelt, escala],
			[funcionarios[3].idfuncionariosroosevelt, escala],
			[funcionarios[4].idfuncionariosroosevelt, escala],
			[funcionarios[5].idfuncionariosroosevelt, escala],
			[funcionarios[6].idfuncionariosroosevelt, escala],
			[funcionarios[7].idfuncionariosroosevelt, escala],
			[funcionarios[8].idfuncionariosroosevelt, escala],
			[funcionarios[9].idfuncionariosroosevelt, escala],
			[funcionarios[10].idfuncionariosroosevelt, escala],
			[funcionarios[11].idfuncionariosroosevelt, escala],
			[funcionarios[12].idfuncionariosroosevelt, escala],
			[funcionarios[13].idfuncionariosroosevelt, escala],
			[funcionarios[14].idfuncionariosroosevelt, escala],
			[funcionarios[15].idfuncionariosroosevelt, escala],
			[funcionarios[16].idfuncionariosroosevelt, escala],
			[funcionarios[17].idfuncionariosroosevelt, escala],
			[funcionarios[18].idfuncionariosroosevelt, escala],
			[funcionarios[19].idfuncionariosroosevelt, escala],
			[funcionarios[20].idfuncionariosroosevelt, escala],
			[funcionarios[21].idfuncionariosroosevelt, escala],
			[funcionarios[22].idfuncionariosroosevelt, escala],
			[funcionarios[23].idfuncionariosroosevelt, escala],
...
modelescalaroosevelt.prototype.updateferias = function(valor, callback){

	this._conection.query('update folgaroosevelt set folga1="'+valor.folga1+'",folga2="'+valor.folga2+'",folga3="'+valor.folga3+'",folga4="'+valor.folga4+'",folga5="'+valor.folga5+'",folga6="'+valor.folga6+'",folga7="'+valor.folga7+'",folga8="'+valor.folga8+'",folga9="'+valor.folga9+'",folga10="'+valor.folga10+'",folga11="'+valor.folga11+'",folga12="'+valor.folga12+'",folga13="'+valor.folga13+'",folga14="'+valor.folga14+'",folga15="'+valor.folga15+'",folga16="'+valor.folga16+'",folga17="'+valor.folga17+'",folga18="'+valor.folga18+'",folga19="'+valor.folga19+'",folga20="'+valor.folga20+'",folga21="'+valor.folga21+'",folga22="'+valor.folga22+'",folga23="'+valor.folga23+'",folga24="'+valor.folga24+'",folga25="'+valor.folga25+'",folga26="'+valor.folga26+'",folga27="'+valor.folga27+'",folga28="'+valor.folga28+'",folga29="'+valor.folga29+'",folga30="'+valor.folga30+'",folga31="'+valor.folga31+'", situacaoferias = "'+valor.inputsituacaoferias+'", dateiniciosituacaoferias = "'+valor.dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+valor.datefinalsituacaoferias+'" where idfolgaroosevelt = "'+valor.idfuncionario+'"', callback);
}
modelescalaroosevelt.prototype.updateferiastarde = function(idfuncionario, inputsituacaoferias, dateinicialsituacaoferias, datefinalsituacaoferias, callback){

	this._conection.query('update folgaroosevelt set situacaoferias = "'+inputsituacaoferias+'", dateiniciosituacaoferias = "'+dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+datefinalsituacaoferias+'" where idfolgaroosevelt = "'+idfuncionario+'"', callback);
}

modelescalaroosevelt.prototype.updateferiasSN1 = function(idfuncionario, inputsituacaoferias, dateinicialsituacaoferias, datefinalsituacaoferias, callback){

	this._conection.query('update folgaroosevelt set situacaoferias = "'+inputsituacaoferias+'", dateiniciosituacaoferias = "'+dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+datefinalsituacaoferias+'" where idfolgaroosevelt = "'+idfuncionario+'"', callback);
}

modelescalaroosevelt.prototype.updateferiasSN2 = function(idfuncionario, inputsituacaoferias, dateinicialsituacaoferias, datefinalsituacaoferias, callback){

	this._conection.query('update folgaroosevelt set situacaoferias = "'+inputsituacaoferias+'", dateiniciosituacaoferias = "'+dateinicialsituacaoferias+'", datefinalsituacaoferias = "'+datefinalsituacaoferias+'" where idfolgaroosevelt = "'+idfuncionario+'"', callback);
}

modelescalaroosevelt.prototype.criarescalaroosevelt = function(unidade, turno, dateinicial, datefinal, ano, callback){
	
	this._conection.query('insert into escalaroosevelt set unidade="Roosevelt", turno="'+turno+'", dateinicial="'+dateinicial+'", datefinal="'+datefinal+'", dateano= "'+ano+'",rt="false",supervisao="false",cida="false"', callback);
}

modelescalaroosevelt.prototype.validarescala = function(unidade, turno, dateinicial, datefinal, rt, supervisao, cida, callback){
	
	this._conection.query('update escalaroosevelt set rt="'+rt+'",supervisao="'+supervisao+'",cida="'+cida+'" where  unidade="Roosevelt" and turno="'+turno+'" and dateinicial="'+dateinicial+'" and datefinal="'+datefinal+'"', callback);
}

modelescalaroosevelt.prototype.buscarsituacaoroosevelt = function(valor, callback){

	this._conection.query('select situacaoferias,dateiniciosituacaoferias from folgaroosevelt where idfolgaroosevelt = "'+valor.idfinal+'"', callback )
}
...
modelescalaroosevelt.prototype.buscarescalamensalrooseveltmaq = function(valor, callback){
	...
	this._conection.query('select * from folgaroosevelt f inner join funcionariosroosevelt func on f.idfuncionarios=func.idfuncionariosroosevelt inner join escalaroosevelt esc on f.idescala = esc.idescala where esc.dateinicial = "'+valor.datainicial+'" and  esc.datefinal = "'+valor.datafinal+'" and  esc.dateano = "'+valor.ano+'" and esc.turno = "'+valor.turno+'" and esc.unidade = "Roosevelt" order by func.nome', callback);
}
