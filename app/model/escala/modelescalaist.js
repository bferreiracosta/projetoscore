...
modelescalaist.prototype.buscarescalamensalist = function(valor, callback){
	this._conection.query('select * from folgaist f inner join funcionariosist func on f.idfuncionarios=func.idfuncionariosist inner join escalaist esc on f.idescala = esc.idescala where esc.dateinicial = "'+valor.datainicial+'" and  esc.datefinal = "'+valor.datafinal+'" and esc.turno = "'+valor.turno+'" and esc.unidade = "IST/AIDS"', callback);
}

modelescalaist.prototype.buscarescalamensalistmulti = function(valor, callback){
	console.log(valor)
	this._conection.query('select * from folgaist f inner join funcionariosist func on f.idfuncionarios=func.idfuncionariosist inner join escalaist esc on f.idescala = esc.idescala where esc.dateinicial = "'+valor.datainicialtarde+'" and  esc.datefinal = "'+valor.datafinaltarde+'" and esc.turno = "'+valor.turno+'" and esc.unidade = "IST/AIDS"', callback);
}
