...
modelescalacer.prototype.criarfolga =  function(funcionarios, escala, turno, callback){
	...
	if(turno == "Diurno"){
		var values = [
			...
			[funcionarios[36].idfuncionarioscer, escala],
			[funcionarios[37].idfuncionarioscer, escala],
...
modelescalacer.prototype.buscarsituacaocer = function(valor, callback){
	...
	this._conection.query('select situacaoferias,dateiniciosituacaoferias from folgacer where idfolgacer = "'+valor.idfinal+'"', callback )
}
