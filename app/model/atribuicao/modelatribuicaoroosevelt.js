...
modelatribuicaoroosevelt.prototype.updatedescanso = function(unidade, date, turno, desc1,desc2,desc3,desc5,desc6,desc7,desc9,desc10,desc11,desc13,desc14,desc15,desc17,desc18,desc19, callback){

	this._conection.query('update atribuicaoroosevelt set desc1="'+desc1+'",desc2="'+desc2+'",desc3="'+desc3+'",desc5="'+desc5+'",desc6="'+desc6+'",desc7="'+desc7+'",desc9="'+desc9+'",desc10="'+desc10+'",desc11="'+desc11+'",desc13="'+desc13+'",desc14="'+desc14+'",desc15="'+desc15+'",desc17="'+desc17+'",desc18="'+desc18+'",desc19="'+desc19+'" where unidade="'+unidade+'" and date="'+date+'"and turno="'+turno+'"', callback);
}
...
modelatribuicaoroosevelt.prototype.adicionandoescalafolga = function(unidade, date, turno, enfermeiro1, enfermeiro2, enfermeiro3, tecnico1, tecnico2, tecnico3, atestado1,atestado2, atestado3, callback){
	console.log(unidade, date, turno)
	this._conection.query('update atribuicaoroosevelt set enfermeiro1="'+enfermeiro1+'", enfermeiro2="'+enfermeiro2+'", enfermeiro3="'+enfermeiro3+'", tecnico1="'+tecnico1+'", tecnico2="'+tecnico2+'", tecnico3="'+tecnico3+'", atestado1="'+atestado1+'",atestado2="'+atestado2+'", atestado3="'+atestado3+'" where unidade="Roosevelt" and date="'+date+'"and turno="'+turno+'"', callback);
}
