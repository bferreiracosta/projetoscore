...
modelatribuicaoplanalto.prototype.adicionarescalaplanalto = function(unidade, date, turno, enf1, tecenf1, maq1, maq2, enfpreposto, tecenf2, tecenf3, tecenf4, tecenf5
	...
	this._conection.query('insert into atribuicaoplanalto set unidade="Planalto",  date="'+date+'", turno="'+turno+'", enf1="'+enf1+'", enf8="'+enf8+'",enf9="'+enf9+'",enf10="'+enf10+'",tecenf16="'+tecenf16+'",tecenf17="'+tecenf17+'",tecenf18="'+tecenf18+'",tecenf19="'+tecenf19+'",tecenf20="'+tecenf20+'",tecenf1="'+tecenf1+'", maq1="'+maq1+'", maq2="'+maq2+'", enfpreposto="'+enfpreposto+'", tecenf2="'+tecenf2+'", tecenf3="'+tecenf3+'", tecenf4="'+tecenf4+'", tecenf5="'+tecenf5+'",tecenf6="'+tecenf6+'", tecenf7="'+tecenf7+'", tecenf8="'+tecenf8+'", tecenf9="'+tecenf9+'", tecenf10="'+tecenf10+'", tecenf11="'+tecenf11+'", tecenf12="'+tecenf12+'", tecenf13="'+tecenf13+'", tecenf14="'+tecenf14+'", tecenf15="'+tecenf15+'", enf2="'+enf2+'", enf3="'+enf3+'", enf4="'+enf4+'", enf5="'+enf5+'", enf6="'+enf6+'" ,enf7="'+enf7+'" ,tecenfcme="'+teccme+'" , enfcme="'+enfcme+'"', callback);
}
modelatribuicaoplanalto.prototype.updatedescanso = function(unidade, date, turno, desc1,desc2,desc3,desc4,desc5,desc6,desc7,desc8,desc9,desc10,desc11,desc12,desc13,desc14,desc15,desc16,desc17,desc18,desc19,desc20, callback){
	...
	this._conection.query('update atribuicaoplanalto set desc1="'+desc1+'",desc2="'+desc2+'",desc3="'+desc3+'",desc4="'+desc4+'",desc5="'+desc5+'",desc6="'+desc6+'",desc7="'+desc7+'",desc8="'+desc8+'",desc9="'+desc9+'",desc10="'+desc10+'",desc11="'+desc11+'",desc12="'+desc12+'",desc13="'+desc13+'",desc14="'+desc14+'",desc15="'+desc15+'",desc16="'+desc16+'",desc17="'+desc17+'",desc18="'+desc18+'",desc19="'+desc19+'",desc20="'+desc20+'" where unidade="'+unidade+'" and date="'+date+'"and turno="'+turno+'"', callback);
}
modelatribuicaoplanalto.prototype.updateescalaplanalto = function(unidade, date, turno, enf1, tecenf1, maq1, maq2, enfpreposto, tecenf2, tecenf3, tecenf4, tecenf5
	,tecenf6, tecenf7, tecenf8, tecenf9, tecenf10, tecenf11, tecenf12, tecenf13, tecenf14, tecenf15,tecenf16,tecenf17,tecenf18,tecenf19,tecenf20,
	 enf2, enf3, enf4, enf5, enf6 , enf7 ,enf8 ,enf9 ,enf10 ,enfcme, teccme, callback){
	
	this._conection.query('update atribuicaoplanalto set  enf1="'+enf1+'", enf8="'+enf8+'",enf9="'+enf9+'",enf10="'+enf10+'",tecenf16="'+tecenf16+'",tecenf17="'+tecenf17+'",tecenf18="'+tecenf18+'",tecenf19="'+tecenf19+'",tecenf20="'+tecenf20+'",tecenf1="'+tecenf1+'", maq1="'+maq1+'", maq2="'+maq2+'", enfpreposto="'+enfpreposto+'", tecenf2="'+tecenf2+'", tecenf3="'+tecenf3+'", tecenf4="'+tecenf4+'", tecenf5="'+tecenf5+'",tecenf6="'+tecenf6+'", tecenf7="'+tecenf7+'", tecenf8="'+tecenf8+'", tecenf9="'+tecenf9+'", tecenf10="'+tecenf10+'", tecenf11="'+tecenf11+'", tecenf12="'+tecenf12+'", tecenf13="'+tecenf13+'", tecenf14="'+tecenf14+'", tecenf15="'+tecenf15+'", enf2="'+enf2+'", enf3="'+enf3+'", enf4="'+enf4+'", enf5="'+enf5+'", enf6="'+enf6+'" ,enf7="'+enf7+'" ,tecenfcme="'+teccme+'" , enfcme="'+enfcme+'" where unidade="Planalto" and date="'+date+'"and turno="'+turno+'"', callback);
}
