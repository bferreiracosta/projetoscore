...
module.exports.updateferias = function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(idusuario, function(error,result){
		modelescalaluizote.updateferias(valor, function(error, resultdoinsert){
			res.send(resultdoinsert);
		})
	});
}
	...
	modelescalaluizote.buscarregraescalaunicaluizote(unidade, turno, dateinicial, datefinal,function(error, resultado){
		...
		if(resultado != null || resultado != ""){
			modeladmin.buscarusuarioeditavel(id, function(error,result){
				modelescalaluizote.validarescala(unidade, turno, dateinicial, datefinal, rt, supervisao, cida, function(error, resultdoinsert){
...
module.exports.criarescalaluizote = function(application, req, res){
	...
	modelescalaluizote.buscarregraescalaunicaluizote(unidade, turno, dateinicial, datefinal,function(error, resultado){
		...
		if(resultado == null || resultado == ""){
			modeladmin.buscarusuarioeditavel(id, function(error,result){
				modelescalaluizote.criarescalaluizote(unidade, turno, dateinicial, datefinal,ano, function(error, resultdoinsert){
...
module.exports.buscarescalamensalluizotemaq = function(application, req, res){
	...
	modelescalaluizote.buscarescalamensalluizotemaq(valor,function(error, resultado){
