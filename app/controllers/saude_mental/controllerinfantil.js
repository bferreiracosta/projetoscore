...
module.exports.baixahospitalidade= function(application, req, res){
	...
	var modelinfantil = new application.app.model.saude_mental.modelinfantil(application);
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){
		modelinfantil.baixahospitalidade(idpaciente,motivo,data,profissional, function(error, result){
			modelinfantil.buscarpaciente(unidade, function(error, resultado){
				res.render("saude_mental/CapsInfantil/cadastrarpacienteinfantil", {mental : resultado, id : resultados});
			});
		});
	});	
}
...
module.exports.central= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelinfantil.buscarleito(function(error, resultado){
			res.render("saude_mental/CapsInfantil/centralad", {leito : resultado, id : result});
		});
	});	
}
...
module.exports.editarleito= function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error, result){
		modelinfantil.updateleito(leitofemad,leitomascad, function(error, resultado){
			modelinfantil.buscarpaciente(unidade, function(error, resultado){
				res.render("saude_mental/CapsInfantil/cadastrarpacienteinfantil", {mental : resultado, id : result});
			});
		});
	});	
}
...
module.exports.editpaciente = function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error,result){
		modelinfantil.buscarpacienteid(idpaciente, unidade, function(error, resultado){
			res.render("saude_mental/CapsInfantil/editpacienteinfantil", {mental: resultado, id : result});
		});
	});
}
