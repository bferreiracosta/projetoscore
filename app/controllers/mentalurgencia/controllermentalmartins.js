...
module.exports.justificarpaciente= function(application, req, res){
	...
	var modelmartins = new application.app.model.mentalurgencia.modelmentalmartins(application);
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpaciente(unidade, function(error, resultado){
			res.render("mentalurgencia/Martins/justificarpacientemartins", {mental : resultado, id : result});
		});
	});	
}
...
module.exports.updatecaps= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmentalmartins.updatecaps(idpaciente,vinculo,motivo, articulacao, matriciado, unidade,  function(error, result){
			modelmentalmartins.buscarpaciente(unidade, function(error, resultado){
				res.render("mentalurgencia/Martins/justificarpacientemartins", {mental : resultado, id : resultados});
			});
		});
	});	
}
...
module.exports.editpacientecaps = function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error,result){
		modelmartins.buscarpacienteid(idpaciente, unidade, function(error, resultado){
			res.render("mentalurgencia/Martins/editmartins", {mental: resultado, id : result});
		});
	});
}
module.exports.baixa= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){
		modelmentalmartins.baixa(idpaciente,baixa,motivo,data, function(error, result){
...
module.exports.cadastrarpaciente= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){
		modelmentalmartins.cadastrarpaciente(prt,paciente, idade,diagnostico,referencia,unidade,data, function(error, result){
			modelmentalmartins.buscarpaciente(unidade, function(error, resultado){
