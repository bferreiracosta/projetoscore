...
module.exports.updateresp= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelluizote.updateresp(idpaciente,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivo,fluxoo2, droga, fio2, peep, sedacao, glasgow,leito,nora, adre,bica,dormonid,fentanil,rocuronio,propofol,bic,  function(error, result){
			modelluizote.buscarpaciente(unidade,function(error, resultado){
...
module.exports.updatedispositivo= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelluizote.updatedispositivo(vmu,vmd,mu,md,bicu,bicd,data, hora,  function(error, result){
			modeladminregulacao.buscardispositivoluizote(function(error, resultado){
				res.render("regulacao/centraluailuizoterelatoriomateriais", {dispositivo : resultado, id : resultados});
			});
		});
	});	
}
