module.exports.cadastrar= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpaciente(unidade, function(error, resultado){
			res.render("regulacao/cadastrarpacientemartins", {paciente : resultado, id : result});
		});
	});	
}
module.exports.relatoriounidade= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpaciente(unidade, function(error, resultado){
			res.render("regulacao/relatoriopacientemartins", {paciente : resultado, id : result});
		});
	});	
}
module.exports.news= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpaciente(unidade, function(error, resultado){
			res.render("regulacao/newsmartins", {paciente : resultado, id : result});
		});
	});	
}
...
module.exports.respiracao= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpaciente(unidade,function(error, resultado){
			res.render("regulacao/respiracaomartins", {paciente : resultado, id : result});
		});
	});	
}
...
module.exports.relatorio= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpacienteporordemprioridadeemergencia(leito, function(error, resultado){
...
module.exports.relatorioadmmartins= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpaciente(unidade, function(error, resultado){
			res.render("regulacao/relatorioadmmartins", {paciente : resultado, id : result});
		});
	});		
}
...
module.exports.relatorioenfermaria= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.buscarpacienteporordemprioridadeenfermaria(leito, function(error, resultado){
...
module.exports.historico= function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error, result){
		modelmartins.historico(unidade, function(error, resultado){
			res.render("regulacao/historicomartins", {paciente : resultado, id : result});
		});
	});		
}
...
module.exports.updatenews= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmartins.updatenews(idpaciente,news,tempo, data, fr, sat, temp, o2, sistolica, fc, alerta, function(error, result){
			modelmartins.buscarpaciente(unidade,function(error, resultado){
				res.render("regulacao/newsmartins", {paciente : resultado, id : resultados});
			});
		});
	});	
}
...
module.exports.updateresp= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmartins.updateresp(idpaciente,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivo,fluxoo2, droga, fio2, peep, sedacao, glasgow,leito,nora, adre,bica,dormonid,fentanil,rocuronio,propofol,bic,  function(error, result){
			modelmartins.buscarpaciente(unidade,function(error, resultado){
				res.render("regulacao/respiracaomartins", {paciente : resultado, id : resultados});
			});
		});
	});	
}
...
module.exports.updatedispositivo= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmartins.updatedispositivo(vmu,vmd,mu,md,bicu,bicd,data, hora,  function(error, result){
			modeladminregulacao.buscardispositivomartins(function(error, resultado){
				res.render("regulacao/centraluaimartinsrelatoriomateriais", {dispositivo : resultado, id : resultados});
			});
		});
	});	
}
...
module.exports.sinaisvitais= function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error,result){
		modelmartins.buscarpacienteid(idpaciente, unidade, function(error, resultado){
			...
			res.render("regulacao/sinaisvitaismartins", {paciente: resultado, id : result});
		});
	});
}
...
module.exports.sinaisvitaisid= function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error,result){
		modelmartins.buscarpacienteregulacao(idpaciente, function(error, resultado){
			console.log(resultado);
...
module.exports.addpaciente = function(application, req, res){
	...
	modeladmin.buscarusuario(id, function(error,result){
		res.render("regulacao/addpacientemartins", {id : result});
	});
}
...
module.exports.editpaciente = function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error,result){
		modelmartins.buscarpacienteid(idpaciente, unidade, function(error, resultado){
			res.render("regulacao/editpacientemartins", {paciente: resultado, id : result});
		});
	});
}
...
module.exports.editnews = function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error,result){
		modelmartins.buscarpacienteid(idpaciente, unidade, function(error, resultado){
			res.render("regulacao/editnewsmartins", {paciente: resultado, id : result});
		});
	});
}
...
module.exports.editresp = function(application, req, res){
	...
	modeladmin.buscarusuarioeditavel(id, function(error,result){
		modelmartins.buscarpacienteid(idpaciente, unidade, function(error, resultado){
			res.render("regulacao/editrespmartins", {paciente: resultado, id : result});
		});
	});
}
