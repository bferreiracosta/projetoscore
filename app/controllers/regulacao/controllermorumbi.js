...
module.exports.updateresp= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmorumbi.updateresp(idpaciente,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivo,fluxoo2, droga, fio2, peep, sedacao, glasgow,leito,nora, adre,bica,dormonid,fentanil,rocuronio,propofol,bic,  function(error, result){
			modelmorumbi.buscarpaciente(unidade,function(error, resultado){
...
module.exports.updatedispositivo= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmorumbi.updatedispositivo(vmu,vmd,mu,md,bicu,bicd,data, hora,  function(error, result){
			modeladminregulacao.buscardispositivomorumbi(function(error, resultado){
				res.render("regulacao/centraluaimorumbirelatoriomateriais", {dispositivo : resultado, id : resultados});
			});
		});
	});	
}
