...
module.exports.updateresp= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modeltibery.updateresp(idpaciente,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivo,fluxoo2, droga, fio2, peep, sedacao, glasgow,leito,nora, adre,bica,dormonid,fentanil,rocuronio,propofol,bic,  function(error, result){
			modeltibery.buscarpaciente(unidade,function(error, resultado){
...
module.exports.updatedispositivo= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modeltibery.updatedispositivo(vmu,vmd,mu,md,bicu,bicd,data, hora,  function(error, result){
			modeladminregulacao.buscardispositivotibery(function(error, resultado){
				res.render("regulacao/centraluaitiberyrelatoriomateriais", {dispositivo : resultado, id : resultados});
			});
		});
	});	
}
