	...
	if(mental == 'true'){
		...
		if(covid == 'true'){
			...
			modeladmin.buscarusuarioporid(id, function(error, resultados){
				modelmartins.cadastrarpaciente(paciente, exame, dataexame, mental, referencia, covid, glasgow, bic, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, function(error, resultdoinsert){
					modelmentalmartins.cadastrarpaciente(prt,dieta, paciente, idade,diagnostico,referencia,unidade,da, function(error, result){
		...
		if(covid == "false"){
			modeladmin.buscarusuarioporid(id, function(error, resultados){
				modelmartins.cadastrarpaciente(paciente, dieta, exame, dataexame, mental, referencia, covid, glasgow, bic, setor,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade, function(error, resultdoinsert){
					modelmartins.adddispositivoid(resultdoinsert.insertId, paciente, unidade, function(error, results){
						modelmartins.addfugulinid(resultdoinsert.insertId,setor, paciente,unidade, function(error, results){
							modelmartins.addtissid(resultdoinsert.insertId,setor, paciente,unidade, function(error, results){
								modelmartins.addnewsid(resultdoinsert.insertId,setor, paciente, unidade,function(error, results){
		...
		if(json[0].dataatualizacao == null){
			modeladmin.buscarusuarioporid(id, function(error, result){	
				modelmartins.updatedispositivo(idpaciente, svd,datasvd,sne,datasne,avp,dataavp,cvc,datacvc,dispositivoventilatorio,fluxoo2,fio2,peep,drogas,nora,vazaonora,adre,vazaoadre,bica,vazaobica,sedacao,dormonid3,vazaoDormonid,fentanil3,vazaoFentanil,rocuronio3,vazaoRocuronio,propofol3,vazaoPropofol,data,unidade,  function(error, resulta){
					modelcovidmartins.updaterespkaban(idpaciente,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivoventilatorio,fluxoo2, drogas, fio2, peep, sedacao,nora, adre,bica,dormonid3,fentanil3,rocuronio3,propofol3,  function(error, resulta){
						modelmartins.buscardispositivo(unidade, function(error, resultado){
			...
			modeladmin.buscarusuarioeditavel(id, function(error, result){	
				modelmartins.adddispositivo(idpaciente, nome, svd,datasvd,sne,datasne,avp,dataavp,cvc,datacvc,dispositivoventilatorio,fluxoo2,fio2,peep,drogas,nora,vazaonora,adre,vazaoadre,bica,vazaobica,sedacao,dormonid3,vazaoDormonid,fentanil3,vazaoFentanil,rocuronio3,vazaoRocuronio,propofol3,vazaoPropofol,data,unidade,  function(error, resulta){
					modelcovidmartins.updaterespkaban(idpaciente,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivoventilatorio,fluxoo2, drogas, fio2, peep, sedacao,nora, adre,bica,dormonid3,fentanil3,rocuronio3,propofol3,  function(error, result){
						modelmartins.updatedispositivostatus(json[0].iddispositivo, function(error, resulta){
							modelmartins.buscardispositivo(unidade, function(error, resultado){
								res.render("kaban/Martins/dispositivomartins", {dispositivo: resultado, id : resulta});
							});
						});	
					});	
				});
...
module.exports.cadastrartiss= function(application, req, res){
	...
	modelmartins.buscartissdataid(idpaciente, unidade, function(error, resultados){
		...
		if(json[0].dataatualizacao == null){
			modeladmin.buscarusuarioporid(id, function(error, result){	
				modelmartins.updatetiss(idpaciente, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,data,unidade,  function(error, resulta){
					modelmartins.buscartiss(unidade, function(error, resultado){
							res.render("kaban/Martins/tissmartins", {tiss: resultado, id : result });
					});
				});
			...
			modeladmin.buscarusuarioeditavel(id, function(error, result){	
				modelmartins.addtiss(idpaciente, setor, nome, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss ,data,unidade,  function(error, resulta){
		...
		if(json[0].dataatualizacao == null){
			modeladmin.buscarusuarioporid(id, function(error, result){	
				modelmartins.updatenews(idpaciente, setor, news, data, fr, sat, temp, o2, sistolica, fc, alerta, unidade,  function(error, resulta){
					modelcovidmartins.updatenews(idpaciente,news,horasreg, datareg, fr, sat, temp, o2, sistolica, fc, alerta, function(error, resulta){
						modelmartins.buscarnews(unidade, function(error, resultado){
								res.render("kaban/Martins/newskabanmartins", {news: resultado, id : result });
						});
					});
		...
		modelmentalmartins.buscarpacientepornome(idpac[0].nome, function(error, idmental){	
			if(mental == 'true' && idpac[0].mental == "true" ){
				if(covid == 'true' && idpac[0].covid == "true"){
					modeladmin.buscarusuarioporid(id, function(error, resultados){	
						modelmartins.update(idpaciente, dieta, dataexame, exame, mental, referencia, covid, glasgow, bic, setor, paciente,susfacil,prt,dn,idade,da,qtdi,ecf,spict,paliativo,diagnostico,especialidade,observacao,banho,pendencias,mobilidade,unidade,  function(error, result){
											...
											modelmartins.updatenewsnome(idpaciente,paciente,setor,  function(error, result){
												modelmartins.updatedispositivonome(idpaciente,paciente,  function(error, result){
													modelmartins.buscardispositivo(unidade, function(error, result){
														modelmartins.buscarpaciente(unidade, function(error, resultado){
															res.render("kaban/Martins/kabanpacientemartins", {paciente : resultado, id : resultados, dispositivo: result});
														});
													});
												});
											});
...
module.exports.updatedispositivokabanmartins= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, result){	
		modelmartins.updatedispositivodados(idpaciente,svd,datasvd,sne,datasne,avp,dataavp,cvc,datacvc,dispositivoventilatorio,fluxoo2,fio2,peep,drogas,nora,vazaonora,adre,vazaoadre,bica,vazaobica,sedacao,dormonid3,vazaoDormonid,fentanil3,vazaoFentanil,rocuronio3,vazaoRocuronio,propofol3,vazaoPropofol,unidade,  function(error, resulta){
			modelcovidmartins.updaterespkaban(idpaciente,vazaoDormonid,vazaoFentanil,vazaoRocuronio,vazaoPropofol,vazaonora,vazaoadre,vazaobica, profissional, dispositivoventilatorio,fluxoo2, drogas, fio2, peep, sedacao,nora, adre,bica,dormonid3,fentanil3,rocuronio3,propofol3,  function(error, resulta){
				modelmartins.buscardispositivo(unidade, function(error, resultado){
						res.render("kaban/Martins/dispositivomartins", {dispositivo: resultado, id : result });
				});
...
module.exports.updatefugulin= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmartins.updatefugulindados(idpaciente, mental2,oxigenacao2,sinaisvitais2,motilidade2,deambulacao2,alimentacao2,cuidado2,eliminacao2,terapeutica2,integridade2,curativo2,tempo2,fugulin,unidade,  function(error, result){
			modelmartins.buscarfugulin(unidade, function(error, resultado){
				res.render("kaban/Martins/fugulinmartins", {fugulin : resultado, id : resultados});
			});
		});
	});	
}
...
module.exports.updatenews= function(application, req, res){
	...
	var modelcovidmartins = new application.app.model.regulacao.modelmartins(application);
			...
			modeladmin.buscarusuarioporid(id, function(error, result){	
				modelmartins.updatenewsdados(idpaciente, setor, news, fr, sat, temp, o2, sistolica, fc, alerta, unidade,  function(error, resulta){
					modelcovidmartins.updatenews(idpaciente,news,horasreg, datareg, fr, sat, temp, o2, sistolica, fc, alerta, function(error, resulta){
						modelmartins.buscarnews(unidade, function(error, resultado){
								res.render("kaban/Martins/newskabanmartins", {news: resultado, id : result });
						});
...
module.exports.updatetiss= function(application, req, res){
	...
	modeladmin.buscarusuarioporid(id, function(error, resultados){	
		modelmartins.updatetissdados(idpaciente, atividades, ventilatorio, cardiovascular, renal, neurologico, metabolico, intervencoes, tiss,unidade,  function(error, result){
			modelmartins.buscartiss(unidade, function(error, resultado){
				res.render("kaban/Martins/tissmartins", {tiss : resultado, id : resultados});
			});
		});
	});	
}
