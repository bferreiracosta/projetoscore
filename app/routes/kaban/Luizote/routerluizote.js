module.exports = function(application) {
	...
	application.get('/buscarclinicoluizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarclinicoluizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscartraumatologialuizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscartraumatologialuizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscarpediatrialuizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarpediatrialuizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscarpsquiatrialuizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarpsquiatrialuizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscarcirurgicooluizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarcirurgicoluizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscarobservacaoluizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarobservacaoluizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscaraltaluizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscaraltaluizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscarevasaoluizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarevasaoluizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscartransferencialuizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscartransferencialuizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscarobitoluizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarobitoluizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
	...
	application.get('/buscarinternacaodialuizote', function(req, res){
		if(req.session.loggedin){
			application.app.controllers.kaban.Luizote.controllerluizote.buscarinternacaodialuizote(application, req, res);
		}
		else{
			var mensage = "Faça login!!";
			res.render("home/index", {msg : mensage});
