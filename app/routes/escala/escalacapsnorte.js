...
module.exports = function(application){
	...
	application.get('/updateferiascapsnorte', function(req, res){
	...
	application.get('/buscarescalamensalcapsnortetarde', function(req, res){
		application.app.controllers.escala.escalacapsnorte.buscarescalamensalcapsnortetarde(application, req, res);
		});	
}
