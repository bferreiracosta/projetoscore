...
module.exports = function(application){
	...
	application.get('/updateferiascapsad', function(req, res){
	...
	application.get('/buscarescalamensalcapsadtarde', function(req, res){
		application.app.controllers.escala.escalacapsad.buscarescalamensalcapsadtarde(application, req, res);
		});	
}
