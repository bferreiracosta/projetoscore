...
module.exports = function(application){
	...
	application.get('/updateferiascapsi', function(req, res){
	...
	application.get('/buscarescalamensalcapsitarde', function(req, res){
		application.app.controllers.escala.escalacapsi.buscarescalamensalcapsitarde(application, req, res);
		});	
}
