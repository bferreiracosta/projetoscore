...
module.exports = function(application){
	...
	application.get('/updateferiascapsleste', function(req, res){
	...
	application.get('/buscarescalamensalcapslestetarde', function(req, res){
		application.app.controllers.escala.escalacapsleste.buscarescalamensalcapslestetarde(application, req, res);
		});	
}
